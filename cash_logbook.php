...
$row=$rs2->fetch_assoc();
	...
	$insert="insert into beginning_balance_cash(log_id,revolving_fund,sjt_net_revenue,svc_net_revenue) values ('".$log_id."','".$revolvingTotal."','".$row['sjt_net_revenue']."','".$row['svc_net_revenue']."')";
