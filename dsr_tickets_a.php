...
<a href='dsr_cash.php<?php echo $clause; ?>'>Part 1</a> | Part 2 | <a href='dsr_tickets_b.php<?php echo $clause; ?>'>Part 3</a> | <a href='dsr_summary_2.php<?php echo $clause; ?>'>Summary</a>
<?php 
if($extAvNM>0){ 
	if(isset($_GET['ext'])){ 
